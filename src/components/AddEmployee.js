        ...
        <div className="px-8 py-8">
            ...
            <div className="items-center justify-center h-14 w-full my-4 space-x-4 pt-4">
                ...
                onClick={saveEmployee}
                 className="rounded text-white font-semibold bg-green-500 py-2 px-6 hover:bg-green-700">Save</button>
                <button
                onClick={reset}
                className="rounded text-white font-semibold bg-red-500 py-2 px-6 hover:bg-red-700">Clear</button>
         </div>
        </div>
    </form>
    </div>
